    ...
    <section>
      <div className="max-w-7xl mx-auto py-16 px-4 md:px-8">
        <PageTitle
          ...
          subtitle="Discover how our students transitioned from confusion to clarity, gained high demand practical skills, and launched successful career paths through hands-on training and mentorship."
        />
