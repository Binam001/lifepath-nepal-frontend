...
function barChartSx() {
  return {
    ...chartSx(),
    "& .MuiChartsAxis-bottom .MuiChartsAxis-line, & .MuiChartsAxis-bottom .MuiChartsAxis-tick, & .MuiChartsAxis-bottom .MuiChartsAxis-tickLabel":
      {
        display: "none",
      },
  };
...
function responsivePieSx(baseSx: ReturnType<typeof chartSx>) {
  return {
    ...baseSx,
        ...
        series={[
          {
            innerRadius:
              innerRadius === undefined
                ? undefined
                : isMobile
                  ? Math.round(innerRadius * 0.72)
                  : innerRadius,
            outerRadius: isMobile
              ? Math.round(outerRadius * 0.74)
              : outerRadius,
            paddingAngle,
            data,
          },
    ...
    case "all":
      return (
        <div className="grid gap-6 lg:grid-cols-12">
          ...
          <Card
            title="5-year market forecast"
            subtitle="Projected trajectory of skill-led hiring, digital leverage, and routine work pressure through 2030."
